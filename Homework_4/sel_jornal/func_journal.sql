...
--Функция
create or replace function LEBEDEV_MA.get_journal_by_patient_surname(
...
begin
    ...
    v_cursor_journal := LEBEDEV_MA.get_journal_by_patient_surname(p_pat_surname => v_pat_surname);
