...
--Функция
create or replace function LEBEDEV_MA.get_all_documents_by_patient_surname(
    p_name varchar2
)
...
begin
    v_surname := 'Шиянов';
    v_cursor_documents := LEBEDEV_MA.get_all_documents_by_patient_surname(p_name => v_surname);
