...
declare
    cursor cursor_1 (p_area varchar2) is select d.SURNAME as Фамилия, d.Name as Имя, g.Name as Гендер, s.NAME as Специальность, q.QUALIFICATION as Квалификация,
        ...
        where d.ID_HOSPITAL = 1 order by q.ID_QUALIFICATION, case when d.AREA = p_area then 0 else 1 end;
    type record_1 is record (surname varchar2(100), name varchar2(100), gender varchar2(25), specName varchar2(100), qualification varchar2(30), salary number, area varchar2(10));
